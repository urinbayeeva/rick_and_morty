...
import 'package:rick_and_morty/infrastructure/services/alice/helper/operating_system.dart';
import 'package:rick_and_morty/infrastructure/services/alice/model/alice_export_result.dart';
import 'package:rick_and_morty/infrastructure/services/alice/model/alice_http_call.dart';
import 'package:rick_and_morty/infrastructure/services/alice/model/alice_translation.dart';
import 'package:rick_and_morty/infrastructure/services/alice/ui/call_details/model/alice_menu_item.dart';
import 'package:rick_and_morty/infrastructure/services/alice/ui/calls_list/model/alice_calls_list_sort_option.dart';
import 'package:rick_and_morty/infrastructure/services/alice/ui/calls_list/model/alice_calls_list_tab_item.dart';
import 'package:rick_and_morty/infrastructure/services/alice/ui/calls_list/widget/alice_inspector_screen.dart';
import 'package:rick_and_morty/infrastructure/services/alice/ui/calls_list/widget/alice_logs_screen.dart';
import 'package:rick_and_morty/infrastructure/services/alice/ui/calls_list/widget/alice_sort_dialog.dart';
import 'package:rick_and_morty/infrastructure/services/alice/ui/common/alice_context_ext.dart';
import 'package:rick_and_morty/infrastructure/services/alice/ui/common/alice_dialog.dart';
import 'package:rick_and_morty/infrastructure/services/alice/ui/common/alice_navigation.dart';
import 'package:rick_and_morty/infrastructure/services/alice/ui/common/alice_page.dart';
...
class _AliceCallsListPageState extends State<AliceCallsListPage>
  ...
  Future<void> _onSortPressed() async {
    AliceSortDialogResult? result = await showDialog<AliceSortDialogResult>(
      context: context,
      builder:
          (BuildContext buildContext) => AliceSortDialog(
            sortOption: _sortOption,
            sortAscending: _sortAscending,
          ),
    );
